      ...
      plans: [
        {
          ...
          name: 'طلب احترافي',
          price: '$19',
          caption: 'كل شيء تحتاجه للبيع الاحترافي عبر واتساب — طلبات، فواتير، وتأكيد دفع تلقائي.',
          quota: 'رقم واتساب واحد',
          features: [
            'طلبات غير محدودة',
            'فاتورة بشعارك وبياناتك',
            'تأكيد الدفع بالذكاء الاصطناعي (OCR)',
            '٣ أعضاء في الفريق',
      ...
      plans: [
        {
          ...
          name: 'Talab Pro',
          price: '$19',
          caption: 'Everything you need to sell professionally on WhatsApp — orders, invoices, and auto payment verification.',
          quota: '1 WhatsApp number',
          features: [
            'Unlimited orders',
            'Branded invoices (with your logo)',
            'AI payment verification (OCR)',
            '3 team members',
            'Sales data export',
            'WhatsApp support',
          ],
