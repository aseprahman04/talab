...
const translations = {
  ar: {
    ...
    pricing: {
      ...
      disclaimer: '⚠ تنبيه: طلب يعمل عبر ربط غير رسمي لواتساب. الاستخدام على مسؤوليتك. لا نتحمل المسؤولية عن أي حظر أو تعليق قد يطرأ على رقمك من طرف واتساب.',
      plans: [
        {
          code: 'free',
          name: 'مجاني',
          price: '$0',
          caption: 'جرّب النظام بدون بطاقة بنكية.',
          quota: 'رقمان واتساب',
          features: [
            '٥٠٠ رسالة شهرياً',
        ...
        },
        {
          ...
          name: 'مبكر',
          price: '$29',
          caption: 'مثالي للأعمال الصغيرة التي تبدأ البيع عبر واتساب.',
        ...
        },
        {
          ...
          name: 'معيار',
          price: '$49',
          caption: 'للأعمال المتنامية التي تحتاج أتمتة أكثر.',
          quota: '٥ أرقام واتساب',
          features: [
            'رسائل غير محدودة',
            'طلبات وفواتير وتأكيد دفع بـ OCR',
            'ردود تلقائية',
        ...
        },
        {
          ...
          name: 'احترافي',
          price: '$79',
          caption: 'كل الميزات لفرق المبيعات الاحترافية.',
          quota: '١٠ أرقام واتساب',
          features: [
            'كل ميزات معيار',
            'وصول كامل للـ API',
            'تكامل مع WATI.io وغيره',
            '١٠ أعضاء في الفريق',
  ...
  en: {
    ...
    pricing: {
      ...
      disclaimer: '⚠ Disclaimer: Talab works via an unofficial WhatsApp connection. Use at your own risk. We are not responsible for any account bans or suspensions imposed by WhatsApp.',
      plans: [
        {
          code: 'free',
          name: 'Free',
          price: '$0',
          caption: 'Try the system with no credit card required.',
          quota: '2 WhatsApp numbers',
          features: [
            '500 messages/month',
        ...
        },
        {
          ...
          name: 'Early',
          price: '$29',
          caption: 'Perfect for small businesses starting to sell on WhatsApp.',
        ...
        },
        {
          ...
          name: 'Standard',
          price: '$49',
          caption: 'For growing businesses that need more automation.',
          quota: '5 WhatsApp numbers',
          features: [
            'Unlimited messages',
            'Orders, invoices & OCR payment verification',
            'Auto-replies',
        ...
        },
        {
          ...
          name: 'Pro',
          price: '$79',
          caption: 'All features for professional sales teams.',
          quota: '10 WhatsApp numbers',
          features: [
            'Everything in Standard',
            'Full API access',
            'WATI.io & other platform integrations',
            '10 team members',
            'Sales data export',
            'Dedicated support',
          ],
